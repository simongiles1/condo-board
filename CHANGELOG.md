...
- **Meetings V2 segmenter compare progress** — Walk and edge are chosen from a **6×6 matrix** (each model plus a **· think** row/column). The **V4 × V4** (no think) cell is the saved pipeline extract; **Done** / **Run** / **L** / **R** live in each cell. Review progress persists per meeting.
